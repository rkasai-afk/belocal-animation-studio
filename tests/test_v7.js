...
async function main() {
  ...
  console.log('2. "All" shows all 15 templates:', allTplBtns.length, allTplBtns.length === 15 ? 'OK' : 'FAIL');
  ...
  console.log('5. back to All restores full list:', restoredBtns.length, restoredBtns.length === 15 ? 'OK' : 'FAIL');
